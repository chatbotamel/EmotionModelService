...
def transformText(text):
    ...
    stopword={'only','being','yourselves','out', 'nor', 'few', 'now', 'd','before', 'their', 'and', 'ourselves','doing', 'its', "you've", 'yourself', 'off', 'do', 'm',
'but', 'after', 'during', 'has', 'for', 'above', 'y', 'on', 've', 'itself', 'been', 'until', 'we', 'shan', 're', 'll', 'o', 'did', 'there', 'you', 'further',
'some', 'where', 'through', 'doesn', 'a', 'it', 'does', 'who','most', 'she','each', 'am', 'if', 'hadn','him', 'the', 'those', 'will', "you'll", 'any', 'why', 'weren', 'ours',
'that', 'other', 'own', 'once','was', 'from', 'this', 'at', 'such', 'than', 'between', 'because', 'while','when', 'so', 'himself','them', 'didn', 's', 'ma', 'shouldn', 'my', 'only', 'then', 'herself', 'under',
'theirs', 'about', 'here', 'his', 'were', 'be', 'with', "you'd", 'are', 'both', 'haven', 'of', 'over', 'won', 'below', 'down', 'ain', 'or', 'to', 'too', 'again', 'an', 'needn', 'what', 'aren', "should've", 'me', 'hers', "that'll",
'just', 'same', 'which', "you're", 'having', "it's", 'can', 'these', 'more', 'i', 'up', 'yours', 'your', 'themselves', 'by', 'don', 'wasn', 'how', 'mightn', 'as', 'all', 'mustn', 'into', 'in', 'is', 't', 'he', 'had', 'her', 
